...
import br.com.appfesta.R;
import br.com.appfesta.constant.FimDeAnoConstants;
import br.com.appfesta.data.SecurityPreferences;
import br.com.appfesta.view.DetailsActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void verifyPresence(){
        ...
        if(presence.matches("")){
            ...
            this.mViewHolder.buttonConfirm.setText(getString(R.string.talvez));
